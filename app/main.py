...
def read_root():
    ...
    <html>
        ...
        <body>
            ...
            <p>The project objective is to train a custom neural networks model that will accurately predict a type of beer based on some rating criteria such as appearance, aroma, palate or taste. Additionally, develop a web app and deploy it online in order to serve the trained model for real-time predictions. <br />Github model: <a href="https://github.com/nuwanprabhath/beer-type-predictor">https://github.com/nuwanprabhath/beer-type-predictor</a>&nbsp;<br />Github API: <a href="https://github.com/nuwanprabhath/nn_api">https://github.com/nuwanprabhath/nn_api</a></p>
            <p>&nbsp;</p>
            <h1>List of endpoints</h1>
            <p>Visit /docs for a detailed explanation of endpoints. A brief explanation of endpoints can be found below</p>
